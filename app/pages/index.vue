...
import onePager from '~/docs/reference/NMC_Balanced_OnePager.html?raw'
import { useSanitizedHtml } from '~/app/composables/useSanitizedHtml'
const html = useSanitizedHtml(onePager)
</script>
